...
- **Farbig**: Führender grün, Spieler mit den wenigsten Punkten konfigurierbar, übrige weiß, Rundeninfo orange
- **Regenbogen-Modus** optional aktivierbar
- **Gewinner-Benachrichtigung** als Awtrix-Notification bei Spielende
- **Pause-Erkennung**: Bei Spielpause erscheint ein konfigurierbarer Text auf dem Display (Standard: „Rauchpause“, in den HA-Optionen änderbar)
...
| Farbe letzter Spieler | `888888` | Hex für Spieler mit den wenigsten Punkten (bei Punktgleichstand aller: wie Führender) |
...
| Text bei Spielpause | `Rauchpause` | Lauftext auf dem Display, solange `is_paused` true ist |
...
- **Thomas: 60** → weiß (Mitte)
- **Thömse: 29** → konfigurierbare „letzter Spieler“-Farbe (wenigste Punkte)
- **(Runde 11)** → orange
